/**
 * Dark Lair Trilogy sound engine, version 3.0.
...
(function () {
  ...
  const OPENING_SOUND = 'assets/audio/parchment-opening-zapsplat-v4.wav';
  ...
  class SoundEngine {
    ...
    playParchment() {
      return this.play(OPENING_SOUND);
    }
    ...
    resumeParchmentAfterNavigation() {
      ...
      const resume = () => {
        const safeOffset = Math.max(0, Math.min(elapsed - 0.08, audio.duration - 0.05));
